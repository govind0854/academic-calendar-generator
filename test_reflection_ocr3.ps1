...
$imagePath = "D:\Desktop\Academic_Calender_Generator\academic-calendar-generator-main\extracted_pages\page_1.png"
...
Write-Host "OCR Result text length:" $ocrResult.Text.Length
Write-Host "OCR Result text snippet:" $ocrResult.Text.Substring(0, [System.Math]::Min(100, $ocrResult.Text.Length))
